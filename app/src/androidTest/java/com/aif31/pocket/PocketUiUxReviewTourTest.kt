...
class PocketUiUxReviewTourTest {
    ...
    fun tour_every_screen_and_major_configuration_state() {
        ...
        pauseForReview()
        compose.onNodeWithText("Atrás").performClick()
        compose.onNodeWithTag("settings_hub_list")
        ...
        compose.waitUntilExactlyOneExists(hasText("Crear backup completo"), TIMEOUT)
        compose.onNodeWithText("Crear backup completo").performScrollTo().assertIsDisplayed()
